...
pd.DataFrame(complexity_records).to_parquet(
    f'{complexity_dir}/enet_hmm_oracle_complexity.parquet', index=False)
...
print_results('ENet-HMM-ORACLE', r2, sharpe, mean_hl)
df_test[['permno', 'eom', 'ret_exc_lead1m', 'y_pred']].to_parquet(
    f'{pred_dir}/enet_hmm_oracle.parquet', index=False)
save_metrics('enet_hmm_oracle', r2, sharpe, mean_hl)
print("Finished.")