...
pd.DataFrame(complexity_records).to_parquet(f'{complexity_dir}/xgb_hmm_complexity.parquet', index=False)
...
print_results('XGB-HMM', r2, sharpe, mean_hl)
df_test[['permno', 'eom', 'ret_exc_lead1m', 'y_pred', 'y_pred_0', 'y_pred_1']].to_parquet(
    f'{pred_dir}/xgb_hmm.parquet', index=False)
save_metrics('xgb_hmm', r2, sharpe, mean_hl)
print("Finished.")